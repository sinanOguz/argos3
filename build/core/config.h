 ...
 */
#ifndef NDEBUG
#  define ARGOS_BUILD_FLAGS " -Wall -Wno-unknown-pragmas -mtune=native -march=native -g -ggdb3"
#else
#  define ARGOS_BUILD_FLAGS " -Wall -Wno-unknown-pragmas -mtune=native -march=native -O3 -DNDEBUG -O3 -DNDEBUG"
#endif
